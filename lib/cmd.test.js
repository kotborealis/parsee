...
{
    assert.throws(() => create_cmd('test', [type.rest, type.number]))
}

{
    const _ = create_cmd('/card', [type.url, type.url, type.string, [type.string]], {strict: true});
    console.log(_('/card "http://a.com/a.png" "http://a.com/a.png" "title"'))
}